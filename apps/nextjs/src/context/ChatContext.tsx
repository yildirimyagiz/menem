...
import type { CommunicationType } from "@acme/db";
...
export function ChatProvider({ children }: ChatProviderProps) {
  ...
  const messagesQuery = api.chat.getMessages.useQuery({ limit: 50 });
  const agentsQuery = api.chat.getSupportAgents.useQuery();
  ...
  const markAllAsReadMutation = api.chat.markAllAsRead.useMutation();
