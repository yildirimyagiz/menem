...
export const DEMO_IMAGE: PropertyGalleryImage[] = [...PHOTOS].map(
...
const PropertyImageGallery: FC<Props> = ({ images = DEMO_IMAGE }) => {
        ...
        {photoId && (
          <Suspense>
            <Modal
              images={images}
              onClose={() => {
                // @ts-expect-error: photoId is a string or number, but setLastViewedPhoto expects a string or number or null
