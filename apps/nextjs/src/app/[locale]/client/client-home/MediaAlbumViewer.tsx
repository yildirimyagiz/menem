import type { Album, MediaItem } from "@/api/property-media.api";
import type { Key } from "react";
import { useEffect, useState } from "react";
import Image from "next/image";
import { generateSharingLink, getAlbumDetails } from "@/api/property-media.api";
        ...
        <>
          <Card>
                ...
                <div className="flex items-center space-x-2">
                  {album.isPublic && album.shareToken ? (
                    ...
                    <Button
                      ...
                      disabled={isLoading}
                    >
                      {isLoading ? "Generating..." : "Share Album"}
                    </Button>
                  )}
                </div>
              </div>
            ...
            <CardContent>
              ...
              {coverImage && (
                <div className="mb-6">
                  <h3 className="mb-2 text-sm font-medium">Album Cover</h3>
                  <div
