      ...
      <CardContent className="p-4">
        <div className="mb-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-sm">{typeof property.averageRating === "number" ? property.averageRating : "N/A"}</span>
          </div>
        </div>
        ...
        <div className="space-y-1 text-sm text-muted-foreground">
          ...
          <p>
            <b>Features:</b> {Array.isArray(property.features) && property.features.length > 0 ? property.features.join(", ") : "N/A"}
          </p>
          <p>
            <b>Amenities:</b> {Array.isArray(property.amenities) && property.amenities.length > 0 ? property.amenities.join(", ") : "N/A"}
          </p>
          <p>
            <b>Pricing Rules:</b> {Array.isArray(property.PricingRules) && property.PricingRules.length > 0 ? property.PricingRules.map((pr) => typeof pr === 'object' && pr && 'name' in pr ? String(pr.name) : '').filter(Boolean).join(", ") : "N/A"}
          </p>
        </div>
      </CardContent>
