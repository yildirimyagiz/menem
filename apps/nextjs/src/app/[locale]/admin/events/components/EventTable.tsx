...
const EventTable: React.FC<EventTableProps> = ({
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex items-center space-x-2">
            ...
            <span>{row.original.attendees ?? 0}</span>
          </div>
        ),
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex items-center">
            ...
            <span>{row.original.averageRating ?? "N/A"}</span>
          </div>
        ),
      },
      {
        id: "location",
        header: "Location",
        cell: ({ row }) => row.original.locationId || "N/A",
      },
      {
        id: "actions",
        header: "Actions",
  ...
  const showColumnManager =
    viewMode === "list" || (viewMode === "grid" && isColumnManagementEnabled);
