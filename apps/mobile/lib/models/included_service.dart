...
part 'included_service.g.dart';

@JsonSerializable()
class IncludedService extends BaseModel {
  final String name;
  ...
  final List<String> extraChargeIds;
  ...
  IncludedService({
    ...
    this.extraChargeIds = const [],
  });

  factory IncludedService.fromJson(Map<String, dynamic> json) =>
      _$IncludedServiceFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$IncludedServiceToJson(this);

  copyWith({required String name, String? description}) {}
}
