...
part of 'included_service.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

IncludedService _$IncludedServiceFromJson(Map<String, dynamic> json) =>
    IncludedService(
      ...
      expenseIds: (json['expenseIds'] as List<dynamic>?)
              ...
              .toList() ??
          const [],
      extraChargeIds: (json['extraChargeIds'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
    );

Map<String, dynamic> _$IncludedServiceToJson(IncludedService instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'extraChargeIds': instance.extraChargeIds,
    };
