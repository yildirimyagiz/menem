...
class ProfileFilters extends StatefulWidget {
  final void Function({String? email, Role? role, UserStatus? status, AccountType? type, String? agencyId}) onChanged;
  const ProfileFilters({super.key, required this.onChanged});

  @override
  State<ProfileFilters> createState() => _ProfileFiltersState();
}

class _ProfileFiltersState extends State<ProfileFilters> {
