...
class ClientUserAvatarDropdown extends ConsumerStatefulWidget {
  const ClientUserAvatarDropdown({super.key});

  @override
  ConsumerState<ClientUserAvatarDropdown> createState() =>
      _ClientUserAvatarDropdownState();
}

class _ClientUserAvatarDropdownState
    extends ConsumerState<ClientUserAvatarDropdown> {
