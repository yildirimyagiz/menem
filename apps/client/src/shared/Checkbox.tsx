  ...
  return (
    <div className={`flex items-start text-sm sm:text-base ${className}`}>
      <input
        ...
        name={name}
        type="checkbox"
        className={`text-primary-500 focus:ring-primary-500 dark:checked:bg-primary-500 h-6 w-6 rounded border-neutral-500 bg-white dark:bg-neutral-700 ${inputClassName}`}
