...
export function AgencyAvatarDropdown() {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      badge: 8,
      onClick: () => {
        router.push("/agency/appointments");
        setIsOpen(false);
      },
    },
    {
  ...
  React.useEffect(() => {
    ...
    function handleClick(e: MouseEvent) {
      const dropdownMenu = document.getElementById("agency-dropdown-menu");
      if (
        buttonRef.current &&
  ...
  const displayName = (user.name || user.username || user.email) ?? "Agency";
    ...
    <div className="relative">
      ...
      >
        ...
        <div className="hidden flex-col items-start md:flex">
          ...
          <Badge
            variant="secondary"
            className="bg-cyan-100 text-xs text-cyan-800"
          >
            ...
            <div className="border-b border-border px-3 py-2">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <Badge
                    variant="secondary"
                    className="mt-1 w-fit bg-cyan-100 text-xs text-cyan-800"
                  >
                    <Shield className="mr-1 h-3 w-3" />
                    Real Estate Agency
                  </Badge>
