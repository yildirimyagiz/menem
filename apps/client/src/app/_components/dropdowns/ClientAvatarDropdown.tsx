...
export function ClientAvatarDropdown() {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      onClick: () => {
        router.push("/client/saved-searches");
        setIsOpen(false);
      },
    },
    {
  ...
  React.useEffect(() => {
    ...
    function handleClick(e: MouseEvent) {
      const dropdownMenu = document.getElementById("client-dropdown-menu");
      if (
        buttonRef.current &&
  ...
  const displayName = user.name || user.username || user.email || "Client";
            ...
            <div className="border-b border-border px-3 py-2">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <Badge
                    variant="secondary"
                    className="mt-1 w-fit bg-gray-100 text-xs text-gray-800"
                  >
                    <Shield className="mr-1 h-3 w-3" />
                    Property Client
                  </Badge>
