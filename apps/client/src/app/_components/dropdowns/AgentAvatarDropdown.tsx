...
export function AgentAvatarDropdown() {
  ...
  const displayName = (user.name ?? user.username) || user.email || "Agent";
            ...
            <div className="border-b border-border px-3 py-2">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <Badge
                    variant="secondary"
                    className="mt-1 w-fit bg-teal-100 text-xs text-teal-800"
                  >
                    <Shield className="mr-1 h-3 w-3" />
                    Real Estate Agent
                  </Badge>
