...
import { TaskTypeEnum } from "@reservatior/validators";

import ButtonPrimary from "~/shared/ButtonPrimary";
import ButtonThird from "~/shared/ButtonThird";
import Checkbox from "~/shared/Checkbox";

// Dynamically generate type options from TaskTypeEnum
const typeOptions = TaskTypeEnum.options.map((name) => ({
  name,
}));

const RenderTabsType: React.FC = () => {
        ...
        <>
          ...
          >
            <span className="inline-flex items-center">
              <i className="las la-tag mr-2 text-lg"></i>
              {t("type.title")}
            </span>
            <i
