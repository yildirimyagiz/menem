...
interface DraggableColProps {
  ...
  col: Column<Property, unknown>;
  columnOrder: { id: string; index: number }[];
  columns: ColumnDef<Property, unknown>[];
  setColumns: (columns: ColumnDef<Property, unknown>[]) => void;
          ...
          {isActionColumn && (
            <Tooltip>
              ...
              <TooltipContent side="top">
                {t("Property.table.actionsColumnLocked")}
              </TooltipContent>
            </Tooltip>
          )}
        </div>
      ...
      <div className="flex items-center gap-2 py-2">
        {isManagementEnabled && (
          <Tooltip>
            ...
            <TooltipContent side="top">
              {t("Property.table.dragToReorderColumn")}
            </TooltipContent>
          </Tooltip>
        )}
