...
interface DraggableGuestRowProps {
  guest: Guest;
  index: number;
  reorderRow: (draggedRowIndex: number, targetRowIndex: number) => void;
  isDragEnabled: boolean;
  cells: Cell<Guest, unknown>[];
  onDragStart?: () => void;
  onDragEnd?: () => void;
}

export const DraggableGuestRow = React.forwardRef<
  HTMLTableRowElement,
  DraggableGuestRowProps
>((props, ref) => {
  const {
    guest,
    index,
...
DraggableGuestRow.displayName = "DraggableGuestRow";
