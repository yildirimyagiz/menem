...
const ModalSelectDate: FC<ModalSelectDateProps> = ({ renderChildren }) => {
  ...
  const renderButtonOpenModal = () => {
    return renderChildren ? (
      ...
      <button
        onClick={openModal}
        className="bg-primary-500 hover:bg-primary-600 focus:ring-primary-500 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-offset-2"
