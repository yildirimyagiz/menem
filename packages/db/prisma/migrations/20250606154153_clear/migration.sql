...
-- CreateEnum
CREATE TYPE "AnalyticsType" AS ENUM ('LISTING_VIEW', 'BOOKING_CONVERSION', 'ML_PROPERTY_SCORE', 'USER_ENGAGEMENT', 'REVENUE', 'PERFORMANCE', 'AGENT_PERFORMANCE', 'AGENCY_PERFORMANCE');
...
-- CreateEnum
CREATE TYPE "FacilityAmenities" AS ENUM ('SWIMMING_POOL', 'FITNESS_CENTER', 'SAUNA', 'JACUZZI', 'TENNIS_COURT', 'BASKETBALL_COURT', 'PLAYGROUND', 'COMMUNITY_CENTER', 'GAME_ROOM', 'CO_WORKING_SPACE', 'BIKE_STORAGE', 'PARKING_GARAGE', 'EV_CHARGING', 'SECURITY_DESK', 'CONCIERGE', 'ELEVATOR', 'LAUNDRY_ROOM', 'PACKAGE_ROOM', 'BBQ_AREA', 'ROOFTOP_TERRACE');
...
-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('UNPAID', 'PARTIALLY_PAID', 'PAID', 'REFUNDED', 'OVERDUE', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "PropertyFeatures" AS ENUM ('FURNISHED', 'PARTIALLY_FURNISHED', 'UNFURNISHED', 'OPEN_FLOOR_PLAN', 'HIGH_CEILING', 'BALCONY', 'TERRACE', 'GARDEN', 'SEA_VIEW', 'MOUNTAIN_VIEW', 'CITY_VIEW', 'SMART_HOME', 'ENERGY_EFFICIENT', 'SOLAR_PANELS', 'EARTHQUAKE_RESISTANT', 'SOUNDPROOF', 'WHEELCHAIR_ACCESSIBLear', 'PET_FRIENDLY', 'HOME_OFFICE', 'WALK_IN_CLOSET');
...
-- CreateEnum
CREATE TYPE "PropertyType" AS ENUM ('SingleFamily', 'TOWNHOUSE', 'CONDO', 'APARTMENT', 'DUPLEX', 'TRIPLEX', 'QUADPLEX', 'OFFICE_BUILDING', 'RETAIL_SPACE', 'WAREHOUSE', 'INDUSTRIAL_COMPLEX', 'MIXED_USE', 'MULTI_FAMILY', 'MOBILE_HOME', 'MANUFACTURED_HOME', 'FARM', 'RANCH');

-- CreateEnum
CREATE TYPE "PropertyCategory" AS ENUM ('APARTMENT', 'HOUSE', 'VILLA', 'OFFICE', 'RETAIL', 'WAREHOUSE', 'FACTORY', 'LAND_PLOT', 'FARM', 'SHOP', 'BUILDING');

-- CreateEnum
CREATE TYPE "PropertyCondition" AS ENUM ('EXCELLENT', 'GOOD', 'FAIR', 'NEEDS_RENOVATION', 'UNDER_CONSTRUCTION');

-- CreateEnum
CREATE TYPE "PropertyAmenities" AS ENUM ('POOL', 'GYM', 'GARDEN', 'PARKING', 'SECURITY', 'ELEVATOR', 'BALCONY', 'TERRACE', 'FURNISHED', 'STORAGE');
...
CREATE TABLE "Property" (
    ...
    "title" TEXT NOT NULL,
    "description" TEXT NOT NULL,
    "propertyType" "PropertyType" NOT NULL DEFAULT 'SingleFamily',
...
-- CreateIndex
CREATE UNIQUE INDEX "_HashtagToProperty_AB_unique" ON "_HashtagToProperty"("A", "B");
