...
export const UpdateExtraChargeSchema = z.object({
  id: z.string(),
...
export const ExtraChargeFilterSchema = z.object({
  name: z.string().optional(),
  facilityId: z.string().optional(),
...
export type ExtraChargeFilterInput = z.infer<typeof ExtraChargeFilterSchema>;
